...
| [DAC80508ZRTER](DAC80508ZRTER/) | 16-bit 8-channel DAC | WQFN-16 | Main | [README](DAC80508ZRTER/README.md) |
...
| [PJS008U](PJS008U/) | Micro SD card socket | THT | Control | [README](PJS008U/README.md) |
...
| ~~FPC_18P_05MM~~ | *(archived)* | — | — | Replaced by FPC_32P_05MM |
...
| [TactileSwitch](TactileSwitch/) | Tactile push button (reset) | SMD | Main | [README](TactileSwitch/README.md) |
...
| Part | Description | Type | Board | Docs |
|------|-------------|------|-------|------|
| [PinHeader1x3](PinHeader1x3/) | 1×3 pin header (SWD debug) | THT | Main | — |
...
| ~~ResistorNetwork9~~ | *(archived)* | — | — | Replaced by ResArray4x0603 |
